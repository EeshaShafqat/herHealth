...
public class PostForumAdapter extends RecyclerView.Adapter<PostForumAdapter.ViewHolder> {
    ...
    public PostForumAdapter(Context context, List<CombinedForumPost> ls) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View row = LayoutInflater.from(context).inflate(R.layout.post_layout_minimal,parent,false);
      ...
      //  String ForumName = ls.get(position).getName();
        ...
        if (ls.get(position).getPost() != null) {
            ...
            if (firstPost != null) {
                ...
                holder.setData( author, PostImage,PostVideo, title, timeAgo, content, likes, dislikes);
            ...
            holder.setData( null, null, null,null, null, null, null, null);
        }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        ImageView comment,postImage,upvote,downvote;
        ...
        public void setData( String author, String PostImage,String PostVideo, String title, String time, String content, Long likes, Long dislikes) {
