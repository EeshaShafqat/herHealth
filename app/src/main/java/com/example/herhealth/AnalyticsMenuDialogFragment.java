...
public class AnalyticsMenuDialogFragment extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.analytics_menu_layout, container, false);

        analyticsTextView = view.findViewById(R.id.analytics);

        Signout = view.findViewById(R.id.signOut);

        // Set an OnClickListener for the "Forums" TextView
        analyticsTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Handle the click event
                // Start the WelcomeToForums activity
                Intent intent = new Intent(getActivity(), Dashboard1.class);
