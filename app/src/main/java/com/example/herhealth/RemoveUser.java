...
public class RemoveUser extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remove_user);// hooks
        ...
        public void onClick(View v) {
            Intent intent = new Intent(RemoveUser.this, AdminMenu.class);
